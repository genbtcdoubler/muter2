...
while (true){"https://bitcoinsp.in/dashboard/get_captcha"};
    
$url="https://bitcoinsp.in/dashboard/get_captcha"
...
echo "https://bitcoinsp.in/dashboard/captcha" alt="https://bitcoinsp.in/dashboard/captcha"><br> : ".$js["alert alert-success"]."Código captcha".$js["Código captcha"]."\n";
sleep(5);
}
?>
